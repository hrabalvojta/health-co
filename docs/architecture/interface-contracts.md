...
**Error handling:**
<!-- What happens if vector DB is unreachable? If no relevant chunks found? -->
...
**Retention:** <!-- AI-SEC: how long must audit logs be kept? -->
**Storage:** <!-- AI-SE: where are logs stored? -->
**Reconstruction SLA:** <!-- Must be able to answer "what happened on date X at time Y" within __ hours -->
