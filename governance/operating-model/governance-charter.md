...
|----------|------------|-----------------|----------------|
| AI system goes to production | <!-- --> | <!-- --> | <!-- --> |
| Policy rule is added/changed | <!-- --> | <!-- --> | <!-- --> |
| Human override is triggered | <!-- --> | <!-- --> | <!-- --> |
| AI system is sunset | <!-- --> | <!-- --> | <!-- --> |
| Budget reallocation | <!-- --> | <!-- --> | <!-- --> |
...
|------------|---------|---------------|--------|
| Risk classification | Art. 6 | `governance/compliance/eu-ai-act-classification.md` | ☐ |
| Technical documentation | Art. 11 | Solution Design + this Charter | ☐ |
| Record-keeping | Art. 12 | Audit Logger + log retention policy | ☐ |
| Transparency | Art. 13 | User interface disclosure | ☐ |
| Human oversight | Art. 14 | HITL protocol + override tracking | ☐ |
| Accuracy & robustness | Art. 15 | Golden dataset + evaluation framework | ☐ |
